...
class Orim(QMainWindow):
    def __init__(self) :
        ...
        self.clearButton=QPushButton('색칠 지우기',self)
        ...
        self.clearButton.setGeometry(210,10,100,30)
        self.cutButton.setGeometry(310,10,100,30)
        self.incButton.setGeometry(410,10,50,30)
        self.decButton.setGeometry(460,10,50,30)
        ...
        self.paintButton.setEnabled(False) # 페인트 버튼 비활성화
        self.cutButton.setEnabled(False) # 오림 버튼 비활성화
    ...
    def fileOpenFunction(self):
        ...
        self.paintButton.setEnabled(True)  #파일 버튼을 눌렀을때 페인트 버튼 활성화
        self.cutButton.setEnabled(False) 
            
    def paintFunction(self):
        self.cutButton.setEnabled(True)  # 페인트 버튼을 눌렀을때 오림 버튼 활성화 
